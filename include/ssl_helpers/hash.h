...
//get first 'limit' bytes of appropriate hash (or all hash for 0)
...
//Password-Based Key Derivation Function 2 (PBKDF2) to create hash from password to use like the key
